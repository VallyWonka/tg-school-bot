...
LITRA_TUTORIAL = """С помощью функции /litra ты можешь получить файл в формате .txt с полным текстом произведения \
с сайта litra.ru.
...
INCORRECT_LITRA_COMMAND_MESSAGE = """Чтобы получить полный текст произведения с сайта litra.ru, используй команду \
...
WIKIPEDIA_TUTORIAL = """Здесь всё просто! Чтобы получить текст статьи из Википедии, после команды /wikipedia \
